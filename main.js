...
// 下のpictureを「自分のgithubのURL/Picture」に変える
var repo_site = "https://smomo7.github.io/self_esteem_iat/Picture/";
...
var survey_other_name02 = {
    ...
    other_name02 = survey_other_name02.choices[data.button_pressed]
...
var survey_other_name03 = {
    ...
    // 修正：保存方法の修正（jsPsych内部のデータに入れるようにする）
    console.log(data.button_pressed);
    console.log(survey_other_name03.choices[data.button_pressed]);
    other_name03 = survey_other_name03.choices[data.button_pressed]
